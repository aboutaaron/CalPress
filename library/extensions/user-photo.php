...
// Modified version of the User Photo plugin (GPL V2) for use with CalPress
...
add_option("userphoto_use_avatar_fallback", true);
add_option("userphoto_override_avatar", true);
...
function userphoto_add_page() {
	...
	add_submenu_page( 'admin-menu.php', 'User Photo Configuration', 'User Photo Config', 'manage_options',  __FILE__, 'userphoto_options_page');
}
