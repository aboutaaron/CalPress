...
define ('CACHE_USE', TRUE);                            // use the cache files? (mostly for testing) + local edit (change to true)
define ('VERSION', '1.15');                                     // version number (to force a cache refresh)
define ('DIRECTORY_CACHE', $cache_dir);          // cache directory + with local edit
define ('DIRECTORY_TEMP', $tmp_dir);            // temp directory + with local edit
