<?php
// Alternate new layout that ships with CalPress. This layout will automatically appear in all child themes. 
// For use in CalPress or child themes, simply select "News2" in the layout selector in the CalPress Producer. 

// This theme can be replaced with another "news2" layout by placing a custom "newss.php" file in the 
...
// The selector takes the form: front-layout-yourfilenameminusthephp. For example, this file (/layout/news2.php)
// adds a body selector like so: body class="front-layout-news2". A custom child theme layout of /layout/breaking-news.php
    ...
    <?php while ( have_posts() ) : the_post() ?>
        ...
        <?php if ($storyCounter === 0): // lead story ?>
            ...
            <?php else: // automated featured story ?> 
                ...
                ?>
                    <?php calpress_loop_content(true, 300, 0, true, true, true, true, 40); ?>
        ...
        <?php elseif ($storyCounter >= 2 && $storyCounter <= 3): //story 3 - 4 ?>
        ...
        <?php elseif ($storyCounter >= 4 && $storyCounter < $maxpost + 1): ?>
            <?php if ($storyCounter === 5): ?>
                <?php calpress_loop_content(false, 0, 0, false,true,true,true, 0); ?>
            <?php else: ?>
                <?php calpress_loop_content(false, 0, 0, false,true,false,false, 0); ?>
            <?php endif ?>
